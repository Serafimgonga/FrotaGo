...
namespace FrotaGo.Infrastructure.Migrations
{
    ...
    [Migration("20260727143840_AddSchoolIdToOperationalEntities")]
    partial class AddSchoolIdToOperationalEntities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FrotaGo.Domain.Entities.Lesson", b =>
                {
                    ...
                    b.Property<string>("ExercisesCompletedJson")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("FrotaGo.Domain.Entities.Student", b =>
                {
                    ...
                    b.Property<bool>("PracticalLessonsStarted")
                        .HasColumnType("boolean");
                    ...
                    b.Property<int>("RequiredLessonsCount")
                        .HasColumnType("integer");

                    b.Property<Guid>("SchoolId")
                        .HasColumnType("uuid");

                    b.Property<bool>("TheoryCompleted")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("FrotaGo.Domain.Entities.Vehicle", b =>
                {
                    ...
                    b.HasIndex("SchoolId", "Chassis")
                        .IsUnique();

                    b.HasIndex("SchoolId", "LicensePlate")
                        .IsUnique();
